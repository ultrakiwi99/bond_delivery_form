            ...
            menu: [
                ...
                },
                {
                    ...
                    products: [
                        ...
                        },
                        {
                            ...
                            sizes: [
                                {short: "Капучино", name: "Капучино", price: 243, selected: true},
                                {short: "Латте", name: "Латте", price: 243, selected: false},
                            ],
                            visible: false
                        },
                        {
                            id: '1234-edaa-0002',
                            name: 'Творожные сырники с соусом',
                            comment: 'Порция из двух нежных творожных сырников с ягодным соусом.',
                            sizes: [
                                {short: "1 порция", name: "1 порция", price: 115, selected: true},
                            ],
                            visible: false
                        },
                    ]
                ...
                },
                {
                    ...
                    products: [
                        ...
                        {
                            id: '1234-beans-0006',
                            name: 'GUATEMALA CRUZ GRANDE (эспрессо, зёрна)',
                            comment: 'Плотный, тельный кофе, с ярким шоколадным оттенком и апельсиновой кислинкой.',
                            sizes: [
                                {short: "250 грамм", name: "250 грамм", price: 599, selected: true},
                            ],
                            visible: false
                        },
                        {
